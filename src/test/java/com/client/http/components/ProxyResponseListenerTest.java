...
class ProxyResponseListenerTest {
    ...
    void listenCompletesFutureByMessageId() {
        ...
        UtilsRecords.HttpProxyResponse r2 = new UtilsRecords.HttpProxyResponse("m2", true, 8, "boom", null);

        proxyResponseListener.handleDeliverySms(List.of(r1.toString(), r2.toString()));
    ...
    void listenIgnoresEmptyBatch() {
        proxyResponseListener.handleDeliverySms(Collections.emptyList());
        proxyResponseListener.handleDeliverySms(null);
    ...
    void listenDiscardsResponseWithoutMessageId() {
        ...
        proxyResponseListener.handleDeliverySms(List.of(noId.toString(), valid.toString()));
